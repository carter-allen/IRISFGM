...
knitr::opts_knit$set(root.dir = "D:/my_analysis/BRIC_TEST/vignette_YAN/")
```
...
# dir.create("~/Vignette/vignette_YAN/",recursive = TRUE)
# setwd("~/Vignette/vignette_YAN")
library(IRISFGM)
```
...
download.file("https://bmbl.bmi.osumc.edu/downloadFiles/Yan_expression.txt",destfile = "./Yan_expression.txt")
download.file("https://bmbl.bmi.osumc.edu/downloadFiles/Yan_cell_label.txt",destfile = "./Yan_cell_label.txt")
InputMatrix <- read.table("~/Vignette/vignette_YAN/Yan_expression.txt",header = T, row.names = 1,check.names = F)
```
...
object <- RunBicluster(object, DiscretizationModel = "Quantile",OpenDual = F,
                       NumBlockOutput = 100, BlockOverlap = 0.5, BlockCellMin = 25)
```
```{r laod_object, include=FALSE}
load("D:/my_analysis/BRIC_TEST/vignette_YAN/Yan.object.Rdata")
```
...
object <- RunPathway(object, N.bicluster =1, species = "Human",database = "GO",genes.source = "Bicluster")
