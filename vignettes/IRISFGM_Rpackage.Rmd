...
my_meta <- read.table("~/Vignette/vignette_YAN/Yan_cell_label.txt",header = TRUE,row.names = 1)
...
PlotHeatmap(object,N.bicluster = c(1, 15),show.clusters = TRUE,show.annotation=TRUE)
```
